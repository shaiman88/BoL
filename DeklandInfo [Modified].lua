...
function LoadMenus()
    ...
    Config.Prints:addParam("break2", "---------Spells---------", SCRIPT_PARAM_INFO, "")
    ...
    Config.Prints:addParam("break3", "---------Animation---------", SCRIPT_PARAM_INFO, "")
    Config.Prints:addParam("AnimationMe", "Only Me", SCRIPT_PARAM_ONOFF, false)
    Config.Prints:addParam("AnimationAllies", "Only Allies", SCRIPT_PARAM_ONOFF, false)
    Config.Prints:addParam("AnimationEnemies", "Only Enemies", SCRIPT_PARAM_ONOFF, false)
    Config.Prints:addSubMenu("Buffs", "buffs")
        Config.Prints.buffs:addParam("name", "Name", SCRIPT_PARAM_ONOFF, true)
        Config.Prints.buffs:addParam("type", "Type", SCRIPT_PARAM_ONOFF, false)
        Config.Prints.buffs:addParam("stack", "Stack", SCRIPT_PARAM_ONOFF, false)
        Config.Prints.buffs:addParam("slot", "Slot", SCRIPT_PARAM_ONOFF, false)
        Config.Prints.buffs:addParam("duration", "Duration", SCRIPT_PARAM_ONOFF, false)
        Config.Prints.buffs:addParam("startT", "Start Time", SCRIPT_PARAM_ONOFF, false)
        Config.Prints.buffs:addParam("endT", "End Time", SCRIPT_PARAM_ONOFF, false)
        Config.Prints.buffs:addParam("source", "Source", SCRIPT_PARAM_ONOFF, false)
    Config.Prints:addSubMenu("Spells", "spells")
        Config.Prints.spells:addParam("name", "Name", SCRIPT_PARAM_ONOFF, true)
        Config.Prints.spells:addParam("pos", "Position", SCRIPT_PARAM_ONOFF, false)
        Config.Prints.spells:addParam("target", "Target", SCRIPT_PARAM_ONOFF, false)
        Config.Prints.spells:addParam("windUpTime", "Wind Up Time", SCRIPT_PARAM_ONOFF, true)
        Config.Prints.spells:addParam("animationTime", "Animation Time", SCRIPT_PARAM_ONOFF, true)
        Config.Prints.spells:addParam("projectileID", "Projectile ID", SCRIPT_PARAM_ONOFF, false)
        Config.Prints.spells:addParam("startPos", "Start Position", SCRIPT_PARAM_ONOFF, false)
        Config.Prints.spells:addParam("endPos", "End Position", SCRIPT_PARAM_ONOFF, false)
...
function GetStringTP(buff)
    local stringTP = ""
    if Config.Prints.buffs.name then stringTP = stringTP.."Name: "..tostring(buff.name) end
    if Config.Prints.buffs.type then stringTP = stringTP.." , Type: "..tostring(buff.type) end
    if Config.Prints.buffs.stack then stringTP = stringTP.." , Stack: "..tostring(buff.stack) end
    if Config.Prints.buffs.slot then stringTP = stringTP.." , Slot: "..tostring(buff.slot) end
    if Config.Prints.buffs.duration then stringTP = stringTP.." , Duration: "..tostring(buff.duration) end
    if Config.Prints.buffs.startT then stringTP = stringTP.." , StartT: "..tostring(buff.startT) end
    if Config.Prints.buffs.endT then stringTP = stringTP.." , EndT: "..tostring(buff.endT) end
    if Config.Prints.buffs.source then stringTP = stringTP.." , Source: "..tostring(buff.source) end
    return stringTP
end
...
function OnGainBuff(unit, buff)
    if unit.isMe and Config.Prints.GainedBuff then
        local stringTP = GetStringTP(buff)
        print(stringTP.." || Gained Buff")
    end
...
function stringconv(...)
    ...
    if len>0 then return table.concat(t) end
end

function OnAnimation(unit, animation)
    if  not string.find(string.lower(unit.charName), "odin") then
        if Config.Prints.AnimationMe and unit.isMe then
            print("Unit: "..unit.charName.." , animation: "..animation.."|| Self Animation")
        end
        if Config.Prints.AnimationAllies and unit.team == myHero.team and not unit.isMe then
            print("Unit: "..unit.charName.." , animation: "..animation.."|| Ally Animation")
        end
        if Config.Prints.AnimationEnemies and unit.team ~= myHero.team then
            print("Unit: "..unit.charName.." , animation: "..animation.."|| Enemy Animation")
        end
    end
end
...
function GetSpellInfo(spell)
    ...
    if Config.Prints.spells.startPos then spellInfo = spellInfo.." , startPos: "..stringconv(Vector(spell.startPos)) end
    if Config.Prints.spells.endPos then spellInfo = spellInfo.." , endPos: "..stringconv(Vector(spell.endPos)) end
    return spellInfo
end
...
function OnProcessSpell(object, spellProc)
    ...
    if object.isMe and Config.Prints.OnProcessSpell then
        local spellInfo = GetSpellInfo(spellProc)
        print(spellInfo.. "|| Spell processed")
    end
